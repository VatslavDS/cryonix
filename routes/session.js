...
function SessionHandler (db) {
    ...
    /* Esta función se agrega al middleware desde el principio de que se ingresa ala aplicación */
    ...
    this.handleLoginRequest = function(req, res, next) {
        ...
        var username = req.body.username; // Para esto sirve el bodyParser
        var password = req.body.password; // Para esto sirve el bodyParser
    ...
    function validateSignup(username, password, verify, email, errors) {
        "use strict";
        var USER_RE = /^[a-zA-Z0-9_-]{3,20}$/; // expresiones regulares para mantener el formato del username
        var PASS_RE = /^.{3,20}$/; //Para el password
        var EMAIL_RE = /^[\S]+@[\S]+\.[\S]+$/; // Y para el email debe contener alñ menos letras antes del @ y despues.un nombre de cominio
